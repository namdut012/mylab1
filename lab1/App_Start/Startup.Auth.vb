...
Partial Public Class Startup
    ...
    Public Sub ConfigureAuth(app As IAppBuilder)
        ...
        app.UseFacebookAuthentication(
           appId:="2341237062803974",
           appSecret:="05e04efaf7c9eaac5db51144ed6f9cab")

        app.UseGoogleAuthentication(New GoogleOAuth2AuthenticationOptions() With {
           .ClientId = "593228103992-amt0qjuhs3lg4hn56jabvnqslvnh6jqa.apps.googleusercontent.com",
           .ClientSecret = "35ai5881n1AzMkr8TFFaqQab"})
    End Sub
End Class
